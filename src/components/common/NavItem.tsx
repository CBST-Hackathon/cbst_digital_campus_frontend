...
//                               key={subItem.key}
//                               href={subItem.link}
//                               className={`${subActive === subItem.key ? 'text-primary-500' : ''} hover:text-primary-500 border-b border-black/5 w-full text-sm flex items-center gap-2 py-2 px-4 font-semibold last:border-b-0 gp-transition`}
//                             >
